...
def main():
    ...
    # Train mask decoder
    if args.freeze >= 3:
        for p in medsam_model.mask_decoder.iou_token.parameters():
            p.requires_grad = False

        for p in medsam_model.mask_decoder.mask_tokens.parameters():
            p.requires_grad = False
    ...
    # for p in medsam_model.mask_decoder.output_hypernetworks_mlps.parameters():
    #     p.requires_grad = True
    # for p in medsam_model.mask_decoder.iou_prediction_head.parameters():
    #     p.requires_grad = True
